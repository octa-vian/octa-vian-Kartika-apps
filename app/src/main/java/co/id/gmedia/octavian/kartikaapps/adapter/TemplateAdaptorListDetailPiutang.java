...
public class TemplateAdaptorListDetailPiutang extends RecyclerView.Adapter<TemplateAdaptorListDetailPiutang.TemplateViewHolder> {

    private Activity activity;
    private List<ModelProduk> listItem;

    public TemplateAdaptorListDetailPiutang(Activity activity, List<ModelProduk> listItem){

...
public class TemplateAdaptorProduk extends RecyclerView.Adapter<TemplateAdaptorProduk.TemplateViewHolder> {

    private Activity activity;
    private List<ModelProduk> listItem;

    public TemplateAdaptorProduk(Activity activity, List<ModelProduk> listItem){

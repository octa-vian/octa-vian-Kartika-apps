...
public class TemplateAdaptorProdukAll extends RecyclerView.Adapter<TemplateAdaptorProdukAll.TemplateViewHolder> {

    private Activity activity;
    private List<ModelProduk> listItem;

    public TemplateAdaptorProdukAll(Activity activity, List<ModelProduk> listItem){

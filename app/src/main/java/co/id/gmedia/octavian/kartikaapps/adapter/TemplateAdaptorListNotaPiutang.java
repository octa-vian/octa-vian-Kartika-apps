...
public class TemplateAdaptorListNotaPiutang extends RecyclerView.Adapter<TemplateAdaptorListNotaPiutang.TemplateViewHolder> {

    private Activity activity;
    private List<ModelProduk> listItem;

    public TemplateAdaptorListNotaPiutang(Activity activity, List<ModelProduk> listItem){

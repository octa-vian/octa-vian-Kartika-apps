...
public class TemplateAdaptorListDetailSO extends RecyclerView.Adapter<TemplateAdaptorListDetailSO.TemplateViewHolder> {

    private Activity activity;
    private List<ModelProduk> listItem;

    public TemplateAdaptorListDetailSO(Activity activity, List<ModelProduk> listItem){

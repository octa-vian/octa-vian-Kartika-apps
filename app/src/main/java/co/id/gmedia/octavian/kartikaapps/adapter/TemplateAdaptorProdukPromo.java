...
import co.id.gmedia.octavian.kartikaapps.activity.DetailActivityBarangPromo;
import co.id.gmedia.octavian.kartikaapps.model.ModelProduk;
import co.id.gmedia.octavian.kartikaapps.util.Constant;


public class TemplateAdaptorProdukPromo extends RecyclerView.Adapter<TemplateAdaptorProdukPromo.TemplateViewHolder> {

    private Activity activity;
    private List<ModelProduk> listItem;

    public TemplateAdaptorProdukPromo(Activity activity, List<ModelProduk> listItem){
    ...
    public void onBindViewHolder(@NonNull TemplateViewHolder templateViewHolder, int i) {
        ...
        templateViewHolder.txt_harga_asli.setText(item.getItem6());
        ...
        templateViewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(activity, DetailActivityBarangPromo.class);

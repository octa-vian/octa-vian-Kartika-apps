...
public class TemplateAdaptorIklan extends RecyclerView.Adapter<TemplateAdaptorIklan.TemplateViewHolder> {

    private Activity activity;
    private List<ModelProduk> listItem;

    public TemplateAdaptorIklan(Activity activity, List<ModelProduk> listItem){

...
public class ModelAddToCart {
    ...
    public ModelAddToCart(String item1, String item2){
        this.item1=item1;
        this.item2=item2;
    }

    public ModelAddToCart(String item1, String item2, String item3){
        this.item1=item1;
        this.item2=item2;
        this.item3=item3;

    }
    public ModelAddToCart(String item1, String item2, String item3, String item4){
        this.item1=item1;
        this.item2=item2;
        this.item3=item3;
        this.item4=item4;
    ...
    public ModelAddToCart(String item1, String item2, String item3, String item4, String item5){
        this.item1=item1;
        this.item2=item2;
        this.item3=item3;
        this.item4=item4;

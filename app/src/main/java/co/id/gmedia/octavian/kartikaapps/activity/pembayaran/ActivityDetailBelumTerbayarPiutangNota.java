...
public class ActivityDetailBelumTerbayarPiutangNota extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Piutang.setLayoutManager(new LinearLayoutManager(ActivityDetailBelumTerbayarPiutangNota.this, LinearLayoutManager.VERTICAL, false));
        adapterPiutang = new TemplateAdaptorListDetailNotaPiutang(ActivityDetailBelumTerbayarPiutangNota.this, listPiutang);
    ...
    private void LoadDetailPembayaran() {
        ...
        new APIvolley(ActivityDetailBelumTerbayarPiutangNota.this, new JSONObject(), "GET", Constant.URL_GET_DETAIL_NOTA_PIUTANG_BELUMTERBAYAR+parameter, new APIvolley.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (status.equals("200")){
                        ...
                        Toast.makeText(ActivityDetailBelumTerbayarPiutangNota.this, message, Toast.LENGTH_LONG).show();
                    }
            ...
            listPiutang.clear();
            adapterPiutang.notifyDataSetChanged();
            Toast.makeText(ActivityDetailBelumTerbayarPiutangNota.this, "Kesalahan Jaringan", Toast.LENGTH_LONG).show();
            }
        });

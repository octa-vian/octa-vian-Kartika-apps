...
public class TemplateAdaptorProdukMerk extends RecyclerView.Adapter<TemplateAdaptorProdukMerk.TemplateViewHolder> {

    private Activity activity;
    private List<ModelProduk> listItem;

    public TemplateAdaptorProdukMerk(Activity activity, List<ModelProduk> listItem){

...
public class DetailActivityBarangPromo extends AppCompatActivity {

    private ModelProduk nota;
    private ImageView img_gambar,img_gambarProduk;
    private TextView txt_nama_brg, txt_harga, txt_status, txt_deskripsi, harga_promo, title_status, txt_ket;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // homeProduk.setLayoutManager(new GridLayoutManager(DetailActivityBarang.this,2));
        homeProduk.setLayoutManager(new LinearLayoutManager(DetailActivityBarangPromo.this, LinearLayoutManager.HORIZONTAL,false));
        adepterproduk = new TemplateAdaptorProdukDetail(DetailActivityBarangPromo.this, viewproduk) ;
        ...
        title_status = findViewById(R.id.title_id);
        txt_ket = findViewById(R.id.txt_ket);

        title_status.setText("Stok");
        ...
        btn_Chat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DetailActivityBarangPromo.this, ActivityChat.class);
        ...
        btn_beli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DetailActivityBarangPromo.this, ActivityPesananPromo.class);
                intent.putExtra(Constant.EXTRA_BARANG,nota.getItem1());
                intent.putExtra(Constant.flag_promo, nota.getItem8());
                startActivity(intent);
            }
        });
    ...
    txt_harga.setText(nota.getItem4());
        ...
        String parameter = String.format(Locale.getDefault(), "?kodebrg=%s&kdpromo=%s", nota.getItem1(), nota.getItem8());
        new APIvolley(DetailActivityBarangPromo.this, new JSONObject(), "GET", Constant.URL_DETAIL_PRODUK+parameter,
                new APIvolley.VolleyCallback() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        try {
                            ...
                            Toast.makeText(DetailActivityBarangPromo.this,"terjadi kesalahan ", Toast.LENGTH_SHORT).show();
    ...
    private void InfoSaya(){
        ...
        new APIvolley(DetailActivityBarangPromo.this, object, "POST", Constant.URL_POST_NOTIFME, new APIvolley.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
                try {
                    ...
                    if(Integer.parseInt(status)== 200){
                        Dialog dialog = new Dialog(DetailActivityBarangPromo.this);

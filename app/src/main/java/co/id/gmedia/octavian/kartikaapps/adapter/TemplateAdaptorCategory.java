...
import co.id.gmedia.octavian.kartikaapps.activity.ActivityListDetailCategory;
import co.id.gmedia.octavian.kartikaapps.model.ModelOneForAll;
import co.id.gmedia.octavian.kartikaapps.util.Constant;


public class TemplateAdaptorCategory extends RecyclerView.Adapter<TemplateAdaptorCategory.TemplateViewHolder> {

    private Activity activity;
    private List<ModelOneForAll> listItem;

    public TemplateAdaptorCategory(Activity activity, List<ModelOneForAll> listItem){
    ...
    public TemplateViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new TemplateViewHolder(LayoutInflater.from(activity).
                inflate(R.layout.adapter_template_category, viewGroup, false));
    }
    ...
    public void onBindViewHolder(@NonNull TemplateViewHolder templateViewHolder, int i) {
        ...
        templateViewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(activity, ActivityListDetailCategory.class);
    ...
    public static class TemplateViewHolder extends RecyclerView.ViewHolder{
        ...
        public TemplateViewHolder(@NonNull View itemView) {
           ...
           txt_nama = (TextView) itemView.findViewById(R.id.txt_nama_category);
